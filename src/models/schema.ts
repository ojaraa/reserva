...
const timeSchema = z.string().regex(/^(0?[1-9]|1[0-2]):[0-5][0-9]\s?(AM|PM)$/i, "Invalid time");
...
export const vendorOnboardingSchema = z.object({
   businessName: z.string().min(1, "Business Name is required"),
    ...
    serviceDuration: z.number( "Duration is required").min(1, "Duration must be more than 0 mins"),
